...
default: $(LIBOPUS_ENCODER) $(LIBOPUS_ENCODER_MIN) $(LIBOPUS_DECODER) $(LIBOPUS_DECODER_MIN) $(RECORDER) $(RECORDER_MIN) $(WAVE_WORKER) $(WAVE_WORKER_MIN) $(LIBOPUS_ENCODER_RAW) $(LIBOPUS_DECODER_RAW) $(LIBOPUS_ENCODER_RAW_MIN) $(LIBOPUS_DECODER_RAW_MIN) test $(CODEC2_ENCODER) $(CODEC2_ENCODER_MIN) $(CODEC2_DECODER) $(CODEC2_DECODER_MIN) 
